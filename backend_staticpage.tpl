...
<defs>
<symbol id="icon-pagetype" viewBox="0 0 1152 1024">
	...
	<path class="path4" d="M928 864c0 17.673-14.327 32-32 32s-32-14.327-32-32c0-17.673 14.327-32 32-32s32 14.327 32 32z"></path>
</symbol>
...
<symbol id="icon-otherplugins" viewBox="0 0 1024 1024">
	<title>otherplugins</title>
...
<symbol id="icon-pagelist" viewBox="0 0 1024 1024">
	<title>pagelist</title>
	<path class="path1" d="M64 192h896v192h-896zM64 448h896v192h-896zM64 704h896v192h-896z"></path>
</symbol>
<symbol id="icon-pageorder" viewBox="0 0 1408 1024">
	<title>pageorder</title>
