{* frontend plugin_staticpage_aboutpage.tpl (overview) file v. 1.03, 2014-12-16 *}
    ...
    *}
    ...
    <div class="clearfix content staticpage_childpages">
        <ul id="staticpage_childpages">
            ...
            <li>{if $childpage.image}<img src="{$childpage.image}" alt="">{/if}<a href="{$childpage.permalink|escape:'html':$CONST.LANG_CHARSET:false}" title="{$childpage.pagetitle|escape:'html':$CONST.LANG_CHARSET:false}">{$childpage.pagetitle|escape:'html':$CONST.LANG_CHARSET:false}</a></li>
