<div class="staticpage_results" style="text-align: left">
    ...
    {foreach from=$staticpage_results item="result"}
        <li><strong><a href="{$result.permalink|escape}" title="{$result.pagetitle|escape}">{$result.headline|escape:'html':$CONST.LANG_CHARSET:$staticpage_doublesc|default:$result.pagetitle|escape}</a></strong> ({$result.realname|escape})<br />
